...
var PartnerSpecificValidator = require('ix-base-htb-validator.js');
...
function IxBaseHtb(configs) {
    ...
    */
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'IxBaseHtb', // PartnerName
            namespace: 'IxBaseHtb', // Should be same as partnerName
            statsId: 'BASE', // Unique partner identifier
            version: '2.0.0',
            targetingType: 'slot',
            enabledAnalytics: {
                requestTime: true
