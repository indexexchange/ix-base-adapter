...
describe('Partner Profile', function () {
    ...
    var partnerModule = proxyquire('../ix-base-htb.js', libraryStubData);
                        ...
                        id: {
                            ...
                            exec: function (schema, post) {
                                ...
                                if (targetingSplit[0] !== 'ix' ||
                                    ...
                                    targetingSplit[2] !== 'id') {
                                    this.report('id tageting key should be of the format ix_{BASE}_id')
                                }
                            }
                        },
                        om: {
                            ...
                            exec: function (schema, post) {
                                ...
                                if (targetingSplit[0] !== 'ix' ||
                                    ...
                                    this.report('om tageting key should be of the format ix_BASE_cpm')
                                }
                            }
                        },
                        pm: {
                            ...
                            exec: function (schema, post) {
                                ...
                                if (targetingSplit[0] !== 'ix' ||
                                    targetingSplit[1] !== profile.statsId.toLowerCase() ||
                                    targetingSplit[2] !== 'cpm') {
                                    this.report('pm tageting key should be of the format ix_BASE_cpm')
                                }
                            }
                        },
                        pmid: {
                            ...
                            exec: function (schema, post) {
                                ...
                                if (targetingSplit[0] !== 'ix' ||
                                    ...
                                    this.report('pmid tageting key should be of the format ix_BASE_dealid')
                                }
                            }
                        }
                    }
